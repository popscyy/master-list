...
def run_ui():
	...
	st.title("LOXON Remarks Upload Pipeline")
	...
	if start_process:
		...
		try:
			...
			if fast_mode:
				st.session_state.step1_combined_daily_remark_bytes = to_output_excel_raw(combined_df, sheet_name="Daily Remark Report")
			else:
